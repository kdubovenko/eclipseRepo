...
extern void b_designLPHPFilter(double N, double BW, double B_data[], int B_size
  [2], double A_data[], int A_size[2]);
extern void designLPHPFilter(double N, double BW, double B_data[], int B_size[2],
